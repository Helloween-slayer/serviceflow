                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div v-if="$page.props.auth.user.telegram_id" class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">
                                    ID: {{ $page.props.auth.user.telegram_id }}
                                </p>
                            </div>
                        ...
                        <div v-else>
                            ...
                            <!-- Альтернативный способ — ввод ID вручную -->
                            <details class="mt-4">
                                <summary class="text-sm text-gray-500 cursor-pointer hover:text-gray-700">
                                    Не можете підключитись? Введіть ID вручну
                                </summary>
                                ...
                                <p class="text-xs text-gray-400 mt-2">
                                    💡 Як дізнатися свій Telegram ID: напишіть боту
                                    <a href="https://t.me/userinfobot" target="_blank" class="text-blue-500 hover:underline">
                                        @userinfobot
                                    </a>
                                </p>
                            </details>
...
/**
 * Подключить Telegram (ручной ввод ID)
 */
const connectTelegram = () => {
    ...
    router.post('/telegram/connect', {
        ...
        onSuccess: () => {
            ...
            router.reload(); // обновляем страницу, чтобы увидеть изменения
        },
        onError: (errors) => {
            connecting.value = false;

...
# Устанавливаем Nginx + системные утилиты
...
# Генерируем конфиг для Nginx прямо в Dockerfile (чтобы не создавать лишних файлов)
RUN echo 'server { \
    listen 10000; \
    root /var/www/public; \
...
# ФИНАЛЬНАЯ КОМАНДА ЗАПУСКА (специально для Render)
